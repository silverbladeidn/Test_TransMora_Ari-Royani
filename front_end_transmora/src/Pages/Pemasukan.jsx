...
function Pemasukan() {
    ...
    const [allStoring, setAllStoring] = useState([]);
    ...
    const translations = {
        en: {
            ...
            to: "To",
            object: "stores",
            loading: "Loading storing data...",
            errorTitle: "Error!",
            errorMessage: "Failed to fetch storing data",
            tryAgain: "Try Again",
            notFoundTitle: "Not Found",
            notFoundMessage: "No storing matches your search",
            clearSearch: "Clear Search",
            noDataTitle: "No Data",
            noDataMessage: "No storing available in database",
        },
        id: {
            tableColumns: {
                id: "ID",
            ...
            to: "Sampai",
            object: "pemasukan",
            loading: "Memuat data pemasukan...",
            errorTitle: "Error!",
            errorMessage: "Gagal mengambil data pemasukan",
            tryAgain: "Coba Lagi",
            notFoundTitle: "Tidak Ditemukan",
            notFoundMessage: "Tidak ada pemasukan yang cocok dengan pencarian",
            clearSearch: "Hapus Pencarian",
            noDataTitle: "Tidak Ada Data",
            noDataMessage: "Belum ada pemasukan barang yang tersedia di database",
        }
    };
    ...
    const fetchAllStoring = async (search = '', dateminim = '', datemaxim = '') => {
        setLoading(true);
        try {
            ...
            const url = `http://localhost:4000/storing${queryString ? `?${queryString}` : ''}`;
    ...
    const applyFilters = useCallback(() => {
        fetchAllStoring(searchTerm, dateMin, dateMax);
                            ...
                            <div className="d-flex flex-column align-items-end">
                                {(searchTerm || dateMin || dateMax) && (
                                    <span className="badge bg-info mb-1">
                                        {t.found}: {storing.length} {t.from} {allStoring.length}
                                    </span>
                                )}
                                <span className="badge bg-success">
                                    {t.total}: {allStoring.length} {t.object}
                                </span>
                            </div>
                        </div>
                    </div>
